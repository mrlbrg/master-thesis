...
\ac{LSMT} are especially well-suited for remote object storage like S3. Objects are immutable and updates require rewriting the entire object, analogous to runs in \ac{LSMT}.
