...
To understand the disk access patterns of B-trees, we analyze the amount of \ac{IO} operations using the \ac{DAM} \cite{aggarwal1988complexity} \cite{kuszmaul2014fractal}.
